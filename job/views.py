...
def job_create(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            form.save()  # Save the new job to the database
            return redirect('job-list')  # Redirect back to the job list page after saving
    else:
        form = JobForm()  # Initialize an empty form for GET requests
